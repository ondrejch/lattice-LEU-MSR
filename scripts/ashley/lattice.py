...
'''.format(**locals())
    ...
    def get_calculated_values(self) -> bool:
        ...
        while not os.path.exists(self.deck_path + '/' + self.deck_name + "_res.m"):
            print("Files Still Running, Waiting 30 Seconds")
            time.sleep(30.0)
...
#            return False
    ...
    def cleanup(self):
        ...
        os.system("rm "+self.qsub_path)

    def for_feedbacks(self):
        'Write decks, save files, run them, and collect data'
        self.get_deck()
        #self.ompcores=32
        self.save_qsub_file()
        self.save_deck()
